...
| [**MaskDINO**](logs/experiment/maskdino-v2-full-run-1xH100-maskdino_R50_bs16_50ep_4s_dowsample1_2048.txt) | **0.584**| **0.9022**| **0.6150**| **0.3670**| **0.6911**| **0.9287**| **0.6802**| **0.9569**| **0.75**|
